...
import 'gradient_panel_decoration.dart';

class ScrollablePageScaffold extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState createState() => _ScrollablePageScaffoldState();
}

class _ScrollablePageScaffoldState extends ConsumerState<ScrollablePageScaffold> {
