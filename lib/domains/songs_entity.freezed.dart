...
SongsEntity _$SongsEntityFromJson(Map<String, dynamic> json) {
  return _SongsEntity.fromJson(json);
}
...
mixin _$SongsEntity {
  ...
  @JsonKey(ignore: true)
  $SongsEntityCopyWith<SongsEntity> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SongsEntityCopyWith<$Res> {
  factory $SongsEntityCopyWith(
          SongsEntity value, $Res Function(SongsEntity) then) =
      _$SongsEntityCopyWithImpl<$Res, SongsEntity>;
  @useResult
  $Res call(
...
/// @nodoc
class _$SongsEntityCopyWithImpl<$Res, $Val extends SongsEntity>
    implements $SongsEntityCopyWith<$Res> {
  _$SongsEntityCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$SongsEntityImplCopyWith<$Res>
    implements $SongsEntityCopyWith<$Res> {
  factory _$$SongsEntityImplCopyWith(
          _$SongsEntityImpl value, $Res Function(_$SongsEntityImpl) then) =
      __$$SongsEntityImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'Id') String id,
...
/// @nodoc
class __$$SongsEntityImplCopyWithImpl<$Res>
    extends _$SongsEntityCopyWithImpl<$Res, _$SongsEntityImpl>
    implements _$$SongsEntityImplCopyWith<$Res> {
  __$$SongsEntityImplCopyWithImpl(
      _$SongsEntityImpl _value, $Res Function(_$SongsEntityImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SongsEntityImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$SongsEntityImpl implements _SongsEntity {
  const _$SongsEntityImpl(
  ...
  factory _$SongsEntityImpl.fromJson(Map<String, dynamic> json) =>
      _$$SongsEntityImplFromJson(json);
  ...
  @override
  String toString() {
    return 'SongsEntity(id: $id, runTimeTicks: $runTimeTicks, indexNumber: $indexNumber, songUserData: $songUserData, type: $type, albumArtist: $albumArtist, albumName: $albumName, name: $name, imageTags: $imageTags)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SongsEntityImplCopyWith<_$SongsEntityImpl> get copyWith =>
      __$$SongsEntityImplCopyWithImpl<_$SongsEntityImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$SongsEntityImplToJson(
      this,
    );
  }
}

abstract class _SongsEntity implements SongsEntity {
  const factory _SongsEntity(
  ...
  factory _SongsEntity.fromJson(Map<String, dynamic> json) =
      _$SongsEntityImpl.fromJson;
...
mixin _$SongsWrapper {
  @JsonKey(name: 'Items')
  List<SongsEntity> get items => throw _privateConstructorUsedError;
...
abstract class $SongsWrapperCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'Items') List<SongsEntity> items});
}
...
class _$SongsWrapperImpl implements _SongsWrapper {
  const _$SongsWrapperImpl(
      {@JsonKey(name: 'Items') required final List<SongsEntity> items})
      : _items = items;

  factory _$SongsWrapperImpl.fromJson(Map<String, dynamic> json) =>
      _$$SongsWrapperImplFromJson(json);

  final List<SongsEntity> _items;
  @override
  @JsonKey(name: 'Items')
  List<SongsEntity> get items {
